...
public class ImplementacionMenu implements InterfazMenu {
	...
	InterfazConexionBD conexion = new ImplementacionConexionBD();
	InterfazConsultaBD consulta = new ImplementacionConsultaBD();
            ...
            try {
                ...
                switch (opcion) {
                    case 0:
                        ...
                        break;
                    case 1:
                    	MenuSeleccionarUnLirbo();
                        break;
                    case 2:
                    	MenuSeleccionarTodosLirbos();
                        break;
                    case 3:
                        MenuInsertarLibro();
                        break;
	...
	public void MenuModificarLibro() {
		...
		try {
			...
			if (libro_modificable != null) {
				...
				LibroDto libro = new LibroDto(libro_modificable.getIdLibro(), titulo, autor, isbn, edicion);
